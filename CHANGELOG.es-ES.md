...
- Acciones de impresión (mapeo acción → impresora): otros plugins registran acciones con nombre e imprimen por acción (`printForAction`, `printerIdForAction`); el administrador asigna la impresora de cada acción desde Admin → Impresoras → Acciones de impresión, con degradación a la impresora predeterminada.
